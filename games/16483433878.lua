...
run(function()
	...
	AutoAction = rise.Categories.Combat:CreateModule({
		Name = 'AutoAction',
...
run(function()
	...
	MissCooldown = rise.Categories.Combat:CreateModule({
		Name = 'MissCooldown',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AntiHazard = rise.Categories.Blatant:CreateModule({
		Name = 'AntiHazard',
		Function = function(callback)
			if callback then
...
run(function()
	...
	FlyingAttack = rise.Categories.Blatant:CreateModule({
		Name = 'FlyingAttack',
		Function = function(callback)
			if callback then
...
run(function()
	...
	PickupTP = rise.Categories.Blatant:CreateModule({
		Name = 'PickupTP',
		Function = function(callback)
			if callback then
				local old
...
run(function()
	...
	SpeedSpin = rise.Categories.Blatant:CreateModule({
		Name = 'SpeedSpin',
		Function = function(callback)
			if callback then
...
run(function()
	...
	PickupTracers = rise.Categories.Render:CreateModule({
		Name = 'PickupTracers',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AutoCamel = rise.Categories.Utility:CreateModule({
		Name = 'AutoCamel',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AutoCloudGrind = rise.Categories.Utility:CreateModule({
		Name = 'AutoCloudGrind',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	AutoFish = rise.Categories.Utility:CreateModule({
		Name = 'AutoFish',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AutoPaint = rise.Categories.Utility:CreateModule({
		Name = 'AutoPaint',
		Function = function(callback)
			if callback then
