...
local function isTarget(plr)
	return (table.find(rise.Categories.Targets.ListEnabled, plr.Name) or tempTargets[plr.Name]) and true
end
...
run(function()
	function Cheats:Flag(plr, flagType, limit)
		...
		if flags[flagType] > limit then
			...
			riseEvents.CheatFlagged:Fire(plr, flagType)
		end
	end
...
run(function()
	...
	entitylib.getEntityColor = function(entity)
		if not (entity.Player and rise.Settings.Modules.Options['Use team color'].Enabled) then
			return
		end
...
run(function()
	...
	if not (pl.Bullet and pl.SwitchTable) then
		repeat
			getShootFunction()
			task.wait()
		until pl.Bullet and pl.SwitchTable or rise.Loaded == nil
	...
	for _, event in {'EntityAdded', 'LocalAdded'} do
		rise:Clean(entitylib.Events[event]:Connect(function()
			OriginScanner:UpdateIgnore()
		end))
	end

	rise:Clean(replicatedStorage.Killfeed.ChildAdded:Connect(function(obj)
		local names = {}
		...
		riseEvents.PlayerKill:Fire(unpack(names))
	...
	rise:Clean(riseEvents.Arrested.Event:Connect(function()
		arrests:Increment()
	end))

	rise:Clean(replicatedStorage.Remotes.MessageReceived.OnClientEvent:Connect(function(msg)
		if msg:find('kicked') then
			cheaterkicked:Increment()

			task.defer(function()
				riseEvents.CheaterKicked:Fire(msg:sub(1, msg:find(' ')))
			end)
		end
	end))

	rise:Clean(entitylib.Events.EntityUpdated:Connect(function(entity)
		if entity.Player and entity.Player.Team == teams.Inmates then
			rise.Categories.Friends.ColorUpdate:Fire()
		end
	end))

	rise:Clean(runService.RenderStepped:Connect(function()
...
run(function()
	...
	AntiInvisible = rise.Categories.Blatant:CreateModule({
		Name = 'AntiInvisible',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AntiKillPlane = rise.Categories.Blatant:CreateModule({
		Name = 'AntiKillPlane',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AntiRiotShield = rise.Categories.Blatant:CreateModule({
		Name = 'AntiRiotShield',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	AntiTaze = rise.Categories.Blatant:CreateModule({
		Name = 'AntiTaze',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AutoArrest = rise.Categories.Blatant:CreateModule({
		Name = 'AutoArrest',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	AutoReset = rise.Categories.Blatant:CreateModule({
		Name = 'AutoReset',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AutoTaser = rise.Categories.Blatant:CreateModule({
		Name = 'AutoTaser',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	FenceGodmode = rise.Categories.Blatant:CreateModule({
		Name = 'FenceGodmode',
		Function = function(callback)
...
run(function()
	...
	GunModifications = rise.Categories.Blatant:CreateModule({
...
run(function()
	...
	NoJumpCooldown = rise.Categories.Blatant:CreateModule({
		Name = 'NoJumpCooldown',
		Function = function(callback)
			if callback then
...
run(function()
	...
	VehicleFly = rise.Categories.Blatant:CreateModule({
		Name = 'VehicleFly',
		Function = function(callback)
			if callback then
				up, down = 0, 0
...
run(function()
	...
	VehicleSpeed = rise.Categories.Blatant:CreateModule({
		Name = 'VehicleSpeed',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	VehicleWallbang = rise.Categories.Blatant:CreateModule({
...
run(function()
	...
	C4ESP = rise.Categories.Render:CreateModule({
		Name = 'C4ESP',
		Function = function(callback)
			if callback then
...
run(function()
	...
	CameraPhase = rise.Categories.Render:CreateModule({
		Name = 'CameraPhase',
		Function = function(callback)
			if callback then
...
run(function()
	...
	KillNotifications = rise.Categories.Render:CreateModule({
		Name = 'KillNotifications',
		Function = function(callback)
			if callback then
				KillNotifications:Clean(riseEvents.PlayerKill.Event:Connect(function(killer, victim)
...
run(function()
	...
	AutoDetonate = rise.Categories.Utility:CreateModule({
		Name = 'AutoDetonate',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AutoReload = rise.Categories.Utility:CreateModule({
		Name = 'AutoReload',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AutoToxic = rise.Categories.Utility:CreateModule({
		...
		Function = function(callback)
			if callback then
				AutoToxic:Clean(riseEvents.CheaterKicked.Event:Connect(function(plr)
...
run(function()
	...
	CheatDetector = rise.Categories.Utility:CreateModule({
		Name = 'CheatDetector',
		Function = function(callback)
			if callback then
				CheatDetector:Clean(riseEvents.CheatFlagged.Event:Connect(function(plr, flagType)
...
run(function()
	...
	AutoArmor = rise.Categories.Inventory:CreateModule({
		Name = 'AutoArmor',
		Function = function(callback)
			if callback then
...
run(function()
	...
	AutoHeal = rise.Categories.Inventory:CreateModule({
		Name = 'AutoHeal',
		Function = function(callback)
			if callback then
				repeat
...
run(function()
	...
	AutoPickup = rise.Categories.Inventory:CreateModule({
		Name = 'AutoPickup',
		Function = function(callback)
			if callback then
...
run(function()
	...
	BulletTracers = rise.Legit:CreateModule({
		Name = 'BulletTracers',
		Function = function(callback)
			if callback then
...
run(function()
	...
	Crosshair = rise.Legit:CreateModule({
		Name = 'Crosshair',
		Function = function(callback)
			if callback then
...
run(function()
	...
	HitSound = rise.Legit:CreateModule({
		Name = 'HitSound',
		Function = function(callback)
			if callback then
				local played
...
run(function()
	...
	KillSound = rise.Legit:CreateModule({
		Name = 'KillSound',
		Function = function(callback)
			if callback then
				KillSound:Clean(riseEvents.PlayerKill.Event:Connect(function(plr)
