...
do
	local riseAssets = {
		['rise/assets/new/add.png'] = 'rbxassetid://121642387707174',
		['rise/assets/new/aim.png'] = 'rbxassetid://122207028123421',
		['rise/assets/new/allowedicon.png'] = 'rbxassetid://112336790299036',
		['rise/assets/new/allowediconmini.png'] = 'rbxassetid://90142384730147',
		['rise/assets/new/back.png'] = 'rbxassetid://80523803497740',
		['rise/assets/new/backmini.png'] = 'rbxassetid://85859225495272',
		['rise/assets/new/bind.png'] = 'rbxassetid://81399857677684',
		['rise/assets/new/bindbkg.png'] = 'rbxassetid://101996225428926',
		['rise/assets/new/blatant.png'] = 'rbxassetid://126929923309265',
		['rise/assets/new/blur.png'] = 'rbxassetid://79246816170155',
		['rise/assets/new/blurnoti.png'] = 'rbxassetid://124705876663719',
		['rise/assets/new/close.png'] = 'rbxassetid://121816018671466',
		['rise/assets/new/closemini.png'] = 'rbxassetid://108320409341289',
		['rise/assets/new/closetiny.png'] = 'rbxassetid://71393233149714',
		['rise/assets/new/colorpreview.png'] = 'rbxassetid://140438628568318',
		['rise/assets/new/combat.png'] = 'rbxassetid://94762732349053',
		['rise/assets/new/customtheme.png'] = 'rbxassetid://91756736022800',
		['rise/assets/new/discord.png'] = 'rbxassetid://99871463341003',
		['rise/assets/new/downexpand.png'] = 'rbxassetid://94197751291504',
		['rise/assets/new/downexpandslider.png'] = 'rbxassetid://90289944682645',
		['rise/assets/new/edit.png'] = 'rbxassetid://105801951237137',
		['rise/assets/new/editlarge.png'] = 'rbxassetid://119233876755282',
		['rise/assets/new/expandarrow.png'] = 'rbxassetid://86360332526471',
		['rise/assets/new/friends.png'] = 'rbxassetid://92957214042038',
		['rise/assets/new/inventory.png'] = 'rbxassetid://93264756888499',
		['rise/assets/new/legit_mode_icon.png'] = 'rbxassetid://102858626075156',
		['rise/assets/new/legit_switch.png'] = 'rbxassetid://127508881124779',
		['rise/assets/new/min.png'] = 'rbxassetid://82175054487146',
		['rise/assets/new/noti_alert.png'] = 'rbxassetid://82356478726846',
		['rise/assets/new/noti_info.png'] = 'rbxassetid://102614825645099',
		['rise/assets/new/noti_warning.png'] = 'rbxassetid://119631730212167',
		['rise/assets/new/notification.png'] = 'rbxassetid://90300780458781',
		['rise/assets/new/npcs.png'] = 'rbxassetid://104434365485227',
		['rise/assets/new/overlaydots.png'] = 'rbxassetid://78012624671930',
		['rise/assets/new/overlays.png'] = 'rbxassetid://136535637407545',
		['rise/assets/new/overlayslarge.png'] = 'rbxassetid://127574141208160',
		['rise/assets/new/pin.png'] = 'rbxassetid://92459145800579',
		['rise/assets/new/players.png'] = 'rbxassetid://105137446428129',
		['rise/assets/new/profiles.png'] = 'rbxassetid://126051451865127',
		['rise/assets/new/radar.png'] = 'rbxassetid://97983828696086',
		['rise/assets/new/rainbow_1.png'] = 'rbxassetid://101329996188554',
		['rise/assets/new/rainbow_2.png'] = 'rbxassetid://72739074644654',
		['rise/assets/new/rainbow_3.png'] = 'rbxassetid://100716555253397',
		['rise/assets/new/rainbow_4.png'] = 'rbxassetid://133424174227092',
		['rise/assets/new/range.png'] = 'rbxassetid://107794917650053',
		['rise/assets/new/rangeindicator.png'] = 'rbxassetid://107038094175283',
		['rise/assets/new/render.png'] = 'rbxassetid://125472576898654',
		['rise/assets/new/search.png'] = 'rbxassetid://115611852955611',
		['rise/assets/new/settingdots.png'] = 'rbxassetid://130896840048276',
		['rise/assets/new/settings.png'] = 'rbxassetid://73820177347303',
		['rise/assets/new/settingsmini.png'] = 'rbxassetid://115732118290997',
		['rise/assets/new/targetinfo.png'] = 'rbxassetid://121604266095276',
		['rise/assets/new/textgui.png'] = 'rbxassetid://99438663817412',
		['rise/assets/new/theme.png'] = 'rbxassetid://111525258317113',
		['rise/assets/new/utility.png'] = 'rbxassetid://108303206513893',
		['rise/assets/new/rise.png'] = 'rbxassetid://92153855792786',
		['rise/assets/new/riselogo.png'] = 'rbxassetid://126205920310261',
		['rise/assets/new/riselogomini.png'] = 'rbxassetid://109041903452149',
		['rise/assets/new/v4.png'] = 'rbxassetid://102549752760489',
		['rise/assets/new/v4mini.png'] = 'rbxassetid://115213099001611',
		['rise/assets/new/world.png'] = 'rbxassetid://118917453153459'
	}

	local function createDownloader(text)
		if rise.Loaded ~= true then
			local downloader = rise.Downloader
			if not downloader then
				...
				downloader.Parent = rise.gui
				rise.Downloader = downloader
			end
	...
	local function downloadFile(path, callback)
		if not isfile(path) then
			...
			if path:find('.lua') then
				data = '--This watermark is used to delete the file if its cached, remove it to make the file persist after rise updates.\n'..data
			end
...
do
	local data = isfile('rise/profiles/color.txt') and loadJson('rise/profiles/color.txt')
	if data then
...
local function addBlur(parent, notif, old)
	...
	if old then
		...
		blur.Image = getriseasset('rise/assets/new/'..(notif and 'blurnoti' or 'blur')..'.png')
...
local function addCloseButton(parent, mini, offset)
	...
	close.Image = getriseasset('rise/assets/new/'..(mini and 'closemini' or 'close')..'.png')
...
function rise:CreateCategory(props)
	return components.Category(props)
end

function rise:CreateCategoryList(props)
	return components.CategoryList(props)
end

function rise:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		notification.Image = getriseasset('rise/assets/new/notification.png')
		...
		iconshadow.Image = getriseasset('rise/assets/new/noti_'..(type or 'info')..'.png')
...
function rise:CreateOverlay(props)
	return components.Overlay(props)
end

function rise:Load(skipgui, profile)
	...
	if isfile('rise/profiles/'..self.Profile..self.Place..'.txt') then
		local mainData = loadJson('rise/profiles/'..self.Profile..self.Place..'.txt')
	...
	if inputService.TouchEnabled and not skipgui then
		...
		image.Image = getriseasset('rise/assets/new/rise.png')
...
function rise:LoadGUI()
	...
	rise:CreateCategory({
		Name = 'Combat',
		Icon = getriseasset('rise/assets/new/combat.png'),
		Size = UDim2.fromOffset(13, 14)
	})
	rise:CreateCategory({
		Name = 'Blatant',
		Icon = getriseasset('rise/assets/new/blatant.png'),
		Size = UDim2.fromOffset(14, 14)
	})
	rise:CreateCategory({
		Name = 'Render',
		Icon = getriseasset('rise/assets/new/render.png'),
		Size = UDim2.fromOffset(15, 14)
	})
	rise:CreateCategory({
		Name = 'Utility',
		Icon = getriseasset('rise/assets/new/utility.png'),
		Size = UDim2.fromOffset(15, 14)
	})
	rise:CreateCategory({
		Name = 'World',
		Icon = getriseasset('rise/assets/new/world.png'),
		Size = UDim2.fromOffset(14, 14)
	})
	rise:CreateCategory({
		Name = 'Inventory',
		Icon = getriseasset('rise/assets/new/inventory.png'),
		Size = UDim2.fromOffset(15, 14)
	})
	rise.Categories.Main:CreateDivider({
		Text = 'misc'
	})
	...
	do
		...
		friends = rise:CreateCategoryList({
			Name = 'Friends',
			Icon = getriseasset('rise/assets/new/friends.png'),
		...
		rise:Clean(friends.Update)
		rise:Clean(friends.ColorUpdate)
	end
	
	--[[
		Profiles
	]]
	rise:CreateCategoryList({
		Name = 'Profiles',
		Icon = getriseasset('rise/assets/new/profiles.png'),
	...
	local targets
	targets = rise:CreateCategoryList({
		Name = 'Targets',
		Icon = getriseasset('rise/assets/new/friends.png'),
		Size = UDim2.fromOffset(17, 16),
		Placeholder = 'Roblox username',
	...
	rise:Clean(targets.Update)
	
	components.LegitWindow()
	rise.SearchBar = components.SearchBar()
	rise.Categories.Main:CreateOverlayBar()
	
	--[[
		General Settings
	]]
	
	local general = rise.Categories.Main.Settings:CreateSettingsPane({Name = 'General'})
	local settingConnections = {}
	rise.MultiKeybind = general:CreateToggle({
	...
	general:CreateToggle({
		...
		Function = function(callback)
			if callback then
				for _, container in {rise.Modules, rise.Legit.Modules} do
								...
								table.insert(settingConnections, bind.Triggered:Connect(function(isDown)
									if bind.Hold then
										if component.Enabled ~= isDown then
											if rise.SettingToggleNotifications.Enabled then
												rise:CreateNotification(module.Name, component.Name..' '..(not component.Enabled and "<font color='#00AA00'>ON</font>" or "<font color='#FF5A5A'>OFF</font>"), 1.5)
											end
	...
	general:CreateButton({
		...
		Function = function()
		rise.Save = function() end
			if isfile('rise/profiles/'..rise.Profile..rise.Place..'.txt') and delfile then
				delfile('rise/profiles/'..rise.Profile..rise.Place..'.txt')
			end
			...
			if shared.RiseDeveloper then
				...
				loadstring(game:HttpGet('https://raw.githubusercontent.com/illusionHD-dev/rise/'..readfile('rise/profiles/commit.txt')..'/loader.lua', true))()
			end
		end,
		Tooltip = 'This will set your profile to the default settings of Rise'
	})
	...
	general:CreateButton({
		...
		Tooltip = 'Removes rise from the current game'
	})
	...
	general:CreateButton({
		...
		Tooltip = 'Reloads rise for debugging purposes'
	})
	...
	local modules = rise.Categories.Main.Settings:CreateSettingsPane({Name = 'Modules'})
	modules:CreateToggle({
		Name = 'Teams by server',
		Tooltip = 'Ignore players on your team designated by the server',
		Default = true,
		Function = function()
			if rise.Libraries.entity and rise.Libraries.entity.Running then
				rise.Libraries.entity.refresh()
			end
		end
	})
	...
	local guipane = rise.Categories.Main.Settings:CreateSettingsPane({Name = 'GUI'})
	rise.Blur = guipane:CreateToggle({
	...
	rise.Scale = guipane:CreateToggle({
		Name = 'Auto rescale',
		Default = true,
		Function = function(callback)
	...
	ScaleSlider = guipane:CreateSlider({
		...
		Function = function(val, final)
			if final and not rise.Scale.Enabled then
				scale.Scale = val
			end
		end,
		Default = 1,
	...
	rise.RainbowSpeed = guipane:CreateSlider({
		Name = 'Rainbow speed',
		Min = 0.1,
		Max = 10,
		Decimal = 10,
	...
	rise.RainbowUpdateSpeed = guipane:CreateSlider({
	...
	--[[guipane:CreateDropdown({
		...
		Tooltip = 'new - The newest rise theme to since v4.05\nold - The rise theme pre v4.05\nrise - Rise 6.0'
	})]]
	...
	guipane:CreateDropdown({
		...
		Function = function(value)
			rise.SearchBar.Object.Visible = value == 'Floating'
		end,
		Tooltip = 'Switch between search bar styles'
	})
	
	rise.RainbowMode = guipane:CreateDropdown({
		Name = 'Rainbow Mode',
	...
	guipane:CreateButton({
		...
		Function = function()
			for _, category in rise.Categories do
	...
	local notifpane = rise.Categories.Main.Settings:CreateSettingsPane({Name = 'Notifications'})
	rise.Notifications = notifpane:CreateToggle({
		Name = 'Notifications',
		Function = function(enabled)
			if rise.ToggleNotifications.Object then
				rise.ToggleNotifications.Object.Visible = enabled
			end
	
			if rise.SettingToggleNotifications.Object then
				rise.SettingToggleNotifications.Object.Visible = enabled
			end
		end,
	...
	rise.ToggleNotifications = notifpane:CreateToggle({
		Name = 'Toggle alert',
		Tooltip = 'Notifies you if a module is enabled/disabled.',
		Default = true,
		Darker = true
	})
	rise.SettingToggleNotifications = notifpane:CreateToggle({
	...
	rise.GUIColor = rise.Categories.Main.Settings:CreateGUISlider({
		Name = 'GUI Theme',
	...
	rise.GUIBind = rise.Categories.Main.Settings:CreateBind({
		Name = 'Rebind GUI',
		Default = {'RightShift'},
		NoRemove = true,
	...
	run(function()
		...
		TextGUI = rise:CreateOverlay({
			Name = 'Text GUI',
			Icon = getriseasset('rise/assets/new/textgui.png'),
		...
		Watermark = TextGUI:CreateToggle({
			Name = 'Watermark',
			Tooltip = 'Renders a rise watermark',
			Function = function()
				rise:UpdateTextGUI()
			end
		})
		...
		Logo.Image = getriseasset('rise/assets/new/riselogo.png')
		Logo.Name = 'Logo'
		...
		LogoV4.Image = getriseasset('rise/assets/new/v4.png')
		LogoV4.Name = 'Logo2'
		...
		rise:Clean(TextGUI.Children:GetPropertyChangedSignal('AbsolutePosition'):Connect(function()
			if rise.ThreadFix then
				setthreadidentity(8)
			end
		...
		function rise:UpdateTextGUI(afterload)
			if not afterload and not rise.Loaded then return end
			if TextGUI.Button.Enabled then
				...
				for name, module in rise.Modules do
		...
		function TextGUI:UpdateColor(hue, sat, val, default)
			LogoGradient.Color = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(1, Gradient.Enabled and Color3.fromHSV(rise:Color((hue - 0.075) % 1)) or Color3.fromHSV(hue, sat, val))
			})
			...
			for index, label in Labels do
				label.Text.TextColor3 = isCustom or (rise.GUIColor.Rainbow and Color3.fromHSV(rise:Color((hue - ((Gradient.Enabled and index + 2 or index) * 0.025)) % 1)) or LogoGradient.Color.Keypoints[2].Value)
	...
	run(function()
		...
		TargetInfoOverlay = rise:CreateOverlay({
			Name = 'Target Info',
			Icon = getriseasset('rise/assets/new/targetinfo.png'),
			Size = UDim2.fromOffset(14, 14),
			Position = UDim2.fromOffset(12, 14),
			CategorySize = 240,
			Function = function(callback)
		...
		function targetinfo:Update()
			local entitylib = rise.Libraries
		...
		rise.Libraries.targetinfo = targetinfo
	end)
	
	rise:Clean(task.spawn(function()
		local hue = 0
		repeat
			for _, component in rise.RainbowSliders do
				if component.Type == 'GUISlider' then
					component:SetValue(rise:Color(hue))
				else
					component:SetValue(hue)
				end
			end
	
			local delta = task.wait(1 / rise.RainbowUpdateSpeed.Value)
			hue = (hue + (delta * (0.2 * rise.RainbowSpeed.Value))) % 1
		until false
	end))
	
	local cursorConnection
	rise:Clean(clickgui:GetPropertyChangedSignal('Visible'):Connect(function()
		rise:UpdateGUI()
		...
		if clickgui.Visible and inputService.MouseEnabled then
			...
			cursorConnection = runService.RenderStepped:Connect(function()
				...
				for _, window in rise.Windows do
	...
	rise:Clean(gui:GetPropertyChangedSignal('AbsoluteSize'):Connect(function()
		if rise.Scale.Enabled then
			scale.Scale = math.max(gui.AbsoluteSize.X / 1920, 0.6)
		end
	end))
	
	rise:Clean(notifications.ChildRemoved:Connect(function()
	...
	rise:Clean(scale:GetPropertyChangedSignal('Scale'):Connect(function()
		scaledgui.Size = UDim2.fromScale(1 / scale.Scale, 1 / scale.Scale)
	...
	rise:Clean(rise.GUIBind.Triggered:Connect(function()
		if rise.ThreadFix then
			setthreadidentity(8)
		end
	...
	rise:Clean(inputService.InputBegan:Connect(function(input)
		if rise.CurrentTooltip and input.KeyCode == Enum.KeyCode.LeftShift then
			rise.CurrentTooltip()
		end
	
		if not inputService:GetFocusedTextBox() and input.KeyCode ~= Enum.KeyCode.Unknown then
			table.insert(rise.HeldKeybinds, input.KeyCode.Name)
			if rise.Binding then return end
	
			for _, bind in rise.ActiveBinds do
				if checkKeybinds(rise.HeldKeybinds, bind.Keys, input.KeyCode.Name) then
	...
	rise:Clean(inputService.InputEnded:Connect(function(input)
		if rise.CurrentTooltip and input.KeyCode == Enum.KeyCode.LeftShift then
			rise.CurrentTooltip()
		end
	
		if not inputService:GetFocusedTextBox() and input.KeyCode ~= Enum.KeyCode.Unknown then
			if rise.Binding then
				if not rise.MultiKeybind.Enabled then
					rise.HeldKeybinds = {input.KeyCode.Name}
				end
	
				rise.Binding:SetBind(rise.HeldKeybinds, true)
				rise.Binding = nil
			else
				for _, bind in rise.ActiveBinds do
					if bind.Hold and checkKeybinds(rise.HeldKeybinds, bind.Keys, input.KeyCode.Name) then
		...
		local index = table.find(rise.HeldKeybinds, input.KeyCode.Name)
		if index then
			table.remove(rise.HeldKeybinds, index)
		end
	end))
end

function rise:Remove(obj)
...
function rise:Save(newProfile)
	...
	writefile('rise/profiles/'..self.Profile..self.Place..'.txt', httpService:JSONEncode(mainData))
end

function rise:SaveOptions(obj)
	local data = {}
...
local guiUpdate
function rise:UpdateGUI()
	if guiUpdate then
		return
	end

	guiUpdate = runService.RenderStepped:Once(function()
		if rise.Loaded ~= nil then
			rise:UpdateGUIQueue(rise.GUIColor.Hue, rise.GUIColor.Sat, rise.GUIColor.Value)
		end
...
function rise:UpdateGUIQueue(hue, sat, val)
	if TextGUI.Button.Enabled then
		TextGUI:UpdateColor(hue, sat, val, default)
	end

	if not clickgui.Visible and not rise.Legit.Window.Visible then return end
	local isRainbow = rise.GUIColor.Rainbow and rise.RainbowMode.Value ~= 'Retro'

	for name, component in rise.Categories do
		component:Color(hue, sat, val, isRainbow)
	end

	for _, component in rise.Modules do
		component:Color(hue, sat, val, isRainbow)
	end

	for _, component in rise.Overlays.Options do
		if component.Color then
			component:Color(hue, sat, val, isRainbow)
		end
	end

	for _, pane in rise.Settings do
	...
	if rise.Legit.Window.Visible then
		for _, component in rise.Legit.Modules do
			component:Color(hue, sat, val, isRainbow)
		end
	end
end
...
components = {
	Bind = function(props, children, api)
		...
		icon.Image = getriseasset('rise/assets/new/bind.png')
		...
		if props.Module then
			if props.Cover then
				...
				cover.Image = getriseasset('rise/assets/new/bindbkg.png')
				cover.Name = 'Cover'
		...
		function component:Destroy()
			...
			local index = table.find(rise.ActiveBinds, self)
			if index then
				table.remove(rise.ActiveBinds, index)
			end
		end
		...
		function component:SetBind(keys, mouse)
			...
			if mouse then
				icon.Image = getriseasset('rise/assets/new/edit.png')
			...
			if #keys <= 0 then
				...
				local index = table.find(rise.ActiveBinds, component)
				if index then
					table.remove(rise.ActiveBinds, index)
				end
			else
				...
				if not table.find(rise.ActiveBinds, component) then
					table.insert(rise.ActiveBinds, component)
				end
			end
		end
		...
		bind.MouseEnter:Connect(function()
			...
			icon.Image = getriseasset(component.Binding and 'rise/assets/new/close.png' or 'rise/assets/new/edit.png')
		...
		bind.MouseLeave:Connect(function()
			...
			icon.Visible = not label.Visible
			icon.Image = getriseasset(component.Binding and 'rise/assets/new/close.png' or 'rise/assets/new/bind.png')
		...
		bind.MouseButton1Click:Connect(function()
			if rise.Binding then
				if rise.Binding == component then
			...
			icon.Image = getriseasset('rise/assets/new/close.png')
			rise.Binding = component
		end)
	...
	Category = function(props, children, api)
		...
		pencil.Image = getriseasset('rise/assets/new/editlarge.png')
		...
		arrow.Image = getriseasset('rise/assets/new/downexpand.png')
		...
		arrowbutton.MouseLeave:Connect(function()
			...
			for _, module in rise.Modules do
		...
		window.MouseEnter:Connect(function()
			pencilbutton.Visible = not rise.EditGUI
		end)
		...
		component.Button = rise.Categories.Main:CreateGUIButton({
			Name = props.Name,
			Icon = props.Icon,
			Size = props.Size,
			Window = window
		...
		rise.Categories[props.Name] = component
	...
	CategoryList = function(props, children, api)
		...
		settings.Image = getriseasset('rise/assets/new/settings.png')
		...
		addbutton.Image = getriseasset('rise/assets/new/add.png')
		...
		function component:CreateProfile(value, data)
			...
			profile.Bind.Triggered:Connect(function(isPressed)
				if isPressed and rise.Profile ~= value then
					rise:Save(value)
					rise:Load(true)
					self:ChangeValue()
				end
		...
		function component:ChangeValue(value, skipGUI)
				...
				if props.Profiles then
					...
					if index then
						if value ~= 'default' then
							...
							if isfile('rise/profiles/'..value..rise.Place..'.txt') and delfile then
								delfile('rise/profiles/'..value..rise.Place..'.txt')
							end
						end
					else
			...
			for _, name in self.List do
				if props.Profiles then
					...
					dots.Image = getriseasset('rise/assets/new/settingdots.png')
					...
					name.Enabled = name.Name == rise.Profile
					...
					close.BackgroundColor3 = Color3.new(1, 1, 1)
					close.BackgroundTransparency = 1
					close.Image = getriseasset('rise/assets/new/closetiny.png')
					close.ImageColor3 = color.Light(uipallet.Text, 0.2)
					close.ImageTransparency = 0.5
		...
		function component:Color(hue, sat, val, isRainbow)
			...
			addbutton.ImageColor3 = isRainbow and Color3.fromHSV(rise:Color(hue % 1)) or Color3.fromHSV(hue, sat, val)
		
			if self.Selected then
				self.Selected.BackgroundColor3 = isRainbow and Color3.fromHSV(rise:Color(hue % 1)) or Color3.fromHSV(hue, sat, val)
				self.Selected.Title.TextColor3 = rise.GUIColor.Rainbow and Color3.new(0.19, 0.19, 0.19) or rise:TextColor(hue, sat, val)
		...
		function component:Load(data)
			rise:LoadOptions(self, data.Options)
	...
	ColorSlider = function(props, children, api)
		...
		preview.Image = getriseasset('rise/assets/new/colorpreview.png')
		...
		local icon = Instance.new('ImageLabel')
		icon.BackgroundTransparency = 1
		icon.Image = getriseasset('rise/assets/new/downexpandslider.png')
		icon.ImageColor3 = color.Dark(uipallet.Text, 0.43)
		...
		ring1.Image = getriseasset('rise/assets/new/rainbow_1.png')
		...
		ring2.Image = getriseasset('rise/assets/new/rainbow_2.png')
		ring2.Parent = rainbow
		local ring3 = Instance.fromExisting(ring1)
		ring3.Image = getriseasset('rise/assets/new/rainbow_3.png')
		ring3.Parent = rainbow
		local ring4 = Instance.fromExisting(ring1)
		ring4.Image = getriseasset('rise/assets/new/rainbow_4.png')
		...
		function component:Toggle()
			...
			if self.Rainbow then
				table.insert(rise.RainbowSliders, self)
				...
				local index = table.find(rise.RainbowSliders, self)
				if index then
					table.remove(rise.RainbowSliders, index)
				end
	...
	Dropdown = function(props, children, api)
		...
		local arrow = Instance.new('ImageLabel')
		arrow.BackgroundTransparency = 1
		arrow.Image = getriseasset('rise/assets/new/expandarrow.png')
		arrow.ImageColor3 = Color3.fromRGB(140, 140, 140)
	...
	GUI = function(props, children, api)
		...
		local logo = Instance.new('ImageLabel')
		logo.BackgroundTransparency = 1
		logo.Image = getriseasset('rise/assets/new/riselogomini.png')
		...
		v4logo.Image = getriseasset('rise/assets/new/v4mini.png')
		v4logo.Name = 'V4Logo'
		...
		settingsicon.Image = getriseasset('rise/assets/new/settings.png')
		...
		discord.Image = getriseasset('rise/assets/new/discord.png')
		...
		function component:Color(hue, sat, val, isRainbow)
			...
			for _, button in self.Buttons do
				if button.Enabled then
					button.Object.TextColor3 = isRainbow and Color3.fromHSV(rise:Color((hue - (button.Index * 0.025)) % 1)) or Color3.fromHSV(hue, sat, val)
		...
		function component:Save(data)
			...
			for name, pane in rise.Settings do
		...
		rise.Categories.Main = component
	...
	GUIButton = function(props, children, api)
		...
		function component:Toggle()
			if props.Window then
				...
				button.TextColor3 = self.Enabled and Color3.fromHSV(rise.GUIColor.Hue, rise.GUIColor.Sat, rise.GUIColor.Value) or uipallet.Text
				if icon then
	...
	GUISlider = function(props, children, api)
		...
		knob.Image = getriseasset('rise/assets/new/theme.png')
		...
		local normalknob = getriseasset('rise/assets/new/theme.png')
		local rainbowknob = getriseasset('rise/assets/new/customtheme.png')
		local rainbowthread
		local currentNotch
	...
	ImageToggle = function(props, children, api)
		...
		function component:Color(hue, sat, val, isRainbow)
			if self.Enabled then
				tween:Cancel(holder)
				holder.BackgroundColor3 = isRainbow and Color3.fromHSV(rise:Color((hue - (self.Index * 0.075)) % 1)) or Color3.fromHSV(hue, sat, val)
			end
		end
		...
		function component:Toggle()
			...
			tween:Tween(holder, uipallet.Tween, {
				BackgroundColor3 = self.Enabled and (isRainbow and Color3.fromHSV(rise:Color((rise.GUIColor.Hue - (self.Index * 0.075)) % 1)) or Color3.fromHSV(rise.GUIColor.Hue, rise.GUIColor.Sat, rise.GUIColor.Value)) or (isHover and color.Light(uipallet.Main, 0.37) or color.Light(uipallet.Main, 0.14))
			})
	...
	LegitModule = function(props, children, api)
		...
		local dots = Instance.new('ImageLabel')
		dots.BackgroundTransparency = 1
		dots.Image = getriseasset('rise/assets/new/overlaydots.png')
		dots.ImageColor3 = color.Light(uipallet.Main, 0.37)
		dots.Name = 'Dots'
		...
		back.Image = getriseasset('rise/assets/new/back.png')
		...
		function component:Toggle()
			...
			tween:Tween(holder, uipallet.Tween, {
				BackgroundColor3 = self.Enabled and Color3.fromHSV(rise.GUIColor.Hue, rise.GUIColor.Sat, rise.GUIColor.Value) or color.Light(uipallet.Main, 0.14)
			})
		...
		shadow:GetPropertyChangedSignal('Visible'):Connect(function()
			tooltip.Visible = false
			rise.LegitVisible = shadow.Visible
		end)
	...
	LegitWindow = function(props, children, api)
		...
		table.insert(rise.Windows, window)
		...
		local icon = Instance.new('ImageLabel')
		icon.BackgroundTransparency = 1
		icon.Image = getriseasset('rise/assets/new/legit_mode_icon.png')
		icon.ImageColor3 = uipallet.Text
		...
		local close = Instance.new('ImageButton')
		close.BackgroundTransparency = 1
		close.Image = getriseasset('rise/assets/new/min.png')
		...
		searchicon.Image = getriseasset('rise/assets/new/search.png')
		...
		rise:Clean(clickgui:GetPropertyChangedSignal('Visible'):Connect(visibleCheck))
	...
	Module = function(props, children, api)
		...
		local component = {
			...
			Index = getTableSize(rise.Modules),
			Name = props.Name,
			Options = {},
			Visible = true
		}
		...
		function component:Color(hue, sat, val, isRainbow)
			if self.Enabled then
				button.BackgroundColor3 = isRainbow and Color3.fromHSV(rise:Color((hue - (self.Index * 0.025)) % 1)) or Color3.fromHSV(hue, sat, val)
				button.TextColor3 = rise.GUIColor.Rainbow and Color3.new(0.19, 0.19, 0.19) or rise:TextColor(hue, sat, val)
				button.UIGradient.Enabled = isRainbow and rise.RainbowMode.Value == 'Gradient'
		
				if button.UIGradient.Enabled then
					button.BackgroundColor3 = Color3.new(1, 1, 1)
					button.UIGradient.Color = ColorSequence.new({
						ColorSequenceKeypoint.new(0, Color3.fromHSV(rise:Color((hue - (self.Index * 0.025)) % 1))),
						ColorSequenceKeypoint.new(1, Color3.fromHSV(rise:Color((hue - ((self.Index + 1) * 0.025)) % 1)))
					})
				end
			...
			if self.Visible then
				editbox.BackgroundColor3 = isRainbow and Color3.fromHSV(rise:Color((hue - (self.Index * 0.025)) % 1)) or Color3.fromHSV(hue, sat, val)
		...
		function component:SetVisible(isVisible, isLoad)
			...
			if isLoad and not rise.EditGUI then
		...
		function component:Toggle(multiple)
			...
			if multiple then
				if not rise.TextGUIThread then
					rise.TextGUIThread = task.defer(function()
						if rise.Loaded ~= nil then
							rise:UpdateTextGUI()
						end
		
						rise.TextGUIThread = nil
					end)
				end
			else
				rise:UpdateTextGUI()
		...
		bind.Triggered:Connect(function(isDown)
			if bind.Hold then
				if component.Enabled ~= isDown then
					if rise.ToggleNotifications.Enabled then
						rise:CreateNotification(props.Name, (not component.Enabled and "<font color='#00AA00'>Enabled</font>" or "<font color='#FF5A5A'>Disabled</font>"), 1.5)
					end
		...
		rise.Modules[props.Name] = component
		rise:SortCategories()
	...
	Overlay = function(props, children, api)
		...
		local component
		component = {
			Button = rise.Overlays:CreateImageToggle({
				Name = props.Name,
				Function = function(callback)
		...
		pin.Image = getriseasset('rise/assets/new/pin.png')
	...
	OverlayBar = function(props, children, api)
		...
		button.Image = getriseasset('rise/assets/new/overlays.png')
		...
		local icon = Instance.new('ImageLabel')
		icon.BackgroundTransparency = 1
		icon.Image = getriseasset('rise/assets/new/overlayslarge.png')
		icon.ImageColor3 = uipallet.Text
	...
	SearchBar = function(props, children, api)
		...
		local icon = Instance.new('ImageLabel')
		icon.BackgroundTransparency = 1
		icon.Image = getriseasset('rise/assets/new/search.png')
		...
		legiticon.Image = getriseasset('rise/assets/new/legit_switch.png')
		legiticon.Name = 'Legit'
		legiticon.Position = UDim2.fromOffset(8, 11)
		legiticon.Size = UDim2.fromOffset(29, 16)
		legiticon.Parent = search
		listenProperty(rise.Categories.Main.Object.RiseLogo.V4Logo, legiticon, 'ImageColor3', legiticon)
		...
		legiticon.MouseButton1Click:Connect(function()
			clickgui.Visible = false
			rise.Legit.Window.Visible = true
			rise.Legit.Window.Position = UDim2.new(0.5, -350, 0.5, -194)
		end)
	...
	SettingsPane = function(props, children, api)
		...
		local back = Instance.new('ImageButton')
		back.BackgroundTransparency = 1
		back.Image = getriseasset('rise/assets/new/backmini.png')
		back.ImageColor3 = color.Light(uipallet.Main, 0.37)
		...
		if props.Main then
			...
			versionlabel.Text = 'Rise '..rise.Version..' '..(
				isfile('rise/profiles/commit.txt') and readfile('rise/profiles/commit.txt'):sub(1, 6) or ''
			)..' '
		...
		function component:Load(data)
			rise:LoadOptions(self, data)
		end
		
		function component:Save(data)
			data[props.Name] = rise:SaveOptions(self)
		end
		...
		rise.Settings[props.Name] = component
	...
	Slider = function(props, children, api)
		...
		holder.Parent = slider
		local fill = Instance.new('Frame')
		fill.BackgroundColor3 = Color3.fromHSV(rise.GUIColor.Hue, rise.GUIColor.Sat, rise.GUIColor.Value)
		...
		local knob = Instance.new('Frame')
		knob.AnchorPoint = Vector2.new(0.5, 0.5)
		knob.BackgroundColor3 = Color3.fromHSV(rise.GUIColor.Hue, rise.GUIColor.Sat, rise.GUIColor.Value)
		knob.Position = UDim2.fromScale(0.5, 0.5)
		knob.Size = UDim2.fromOffset(14, 14)
		knob.Parent = knobholder
		addCorner(knob, UDim.new(1, 0))
		...
		function component:Color(hue, sat, val, isRainbow)
			fill.BackgroundColor3 = isRainbow and Color3.fromHSV(rise:Color((hue - (self.Index * 0.075)) % 1)) or Color3.fromHSV(hue, sat, val)
	...
	Targets = function(props, children, api)
		...
		local icon = Instance.new('ImageLabel')
		icon.BackgroundTransparency = 1
		icon.Image = getriseasset('rise/assets/new/aim.png')
		...
		component.Players = components.TargetsButton({
			...
			Icon = getriseasset('rise/assets/new/players.png'),
		...
		component.NPCs = components.TargetsButton({
			...
			Icon = getriseasset('rise/assets/new/npcs.png'),
		...
		button.MouseButton1Click:Connect(function()
			...
			holder.BackgroundColor3 = targetswindow.Visible and Color3.fromHSV(rise.GUIColor.Hue, rise.GUIColor.Sat, rise.GUIColor.Value) or color.Light(uipallet.Main, 0.37)
		end)
	...
	TargetsButton = function(props, children, api)
		...
		function component:Toggle()
			...
			tween:Tween(holder, uipallet.Tween, {
				BackgroundColor3 = self.Enabled and Color3.fromHSV(rise.GUIColor.Hue, rise.GUIColor.Sat, rise.GUIColor.Value) or uipallet.Main
			})
		...
		targetsbutton.MouseEnter:Connect(function()
			if not component.Enabled then
				tween:Tween(holder, uipallet.Tween, {
					BackgroundColor3 = Color3.fromHSV(rise.GUIColor.Hue, rise.GUIColor.Sat, rise.GUIColor.Value - 0.25)
				})
	...
	TextList = function(props, children, api)
		...
		local icon = Instance.new('ImageLabel')
		icon.BackgroundTransparency = 1
		icon.Image = getriseasset('rise/assets/new/allowediconmini.png')
		...
		textlistwindow.Parent = api.Legit and rise.Legit.Window or clickgui
		component.Window = textlistwindow
		addBlur(textlistwindow)
		addCorner(textlistwindow)
		local icon = Instance.new('ImageLabel')
		icon.BackgroundTransparency = 1
		icon.Image = getriseasset('rise/assets/new/allowedicon.png')
		icon.Position = UDim2.fromOffset(10, 13)
		...
		add.Image = getriseasset('rise/assets/new/add.png')
		...
		button.MouseButton1Click:Connect(function()
			...
			tween:Cancel(holder)
			holder.BackgroundColor3 = textlistwindow.Visible and Color3.fromHSV(rise.GUIColor.Hue, rise.GUIColor.Sat, rise.GUIColor.Value) or color.Light(uipallet.Main, 0.37)
		end)
		...
		textlist:GetPropertyChangedSignal('AbsolutePosition'):Connect(function()
			...
			local actualPosition = (textlist.AbsolutePosition - (api.Legit and rise.Legit.Window.AbsolutePosition or -guiService:GetGuiInset())) / scale.Scale
	...
	TwoSlider = function(props, children, api)
		...
		knobknob.Image = getriseasset('rise/assets/new/range.png')
		knobknob.ImageColor3 = Color3.fromHSV(rise.GUIColor.Hue, rise.GUIColor.Sat, rise.GUIColor.Value)
		...
		local arrow = Instance.new('ImageLabel')
		arrow.BackgroundTransparency = 1
		arrow.Image = getriseasset('rise/assets/new/rangeindicator.png')
...
rise.Components = setmetatable(components, {
	__newindex = function(_, index, callback)
		...
		if rise.Legit then
			for _, module in rise.Legit.Modules do
				rawset(module, 'Create'..index, function(_, props)
					return callback(props, module.Children, module)
				end)
			end
